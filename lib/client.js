...
var sidebarDeleteEnabled = true;
function setSidebarDeleteEnabled(enabled) {
  sidebarDeleteEnabled = enabled;
  if (!enabled) {
    for (const el of document.querySelectorAll("[data-query-jump-delete]")) {
      el.previousElementSibling?.matches("div") && el.previousElementSibling.remove();
      el.remove();
    }
  }
}
function DeleteSessionButtonGate({
  sessionId,
  useSessions,
  rpc,
  isLoopback,
  ...
  (0, import_react.useEffect)(() => {
    ...
    void load();
    const tmr = window.setInterval(() => void load(), 3e3);
    return () => window.clearInterval(tmr);
  }, [rpc, isLoopback]);
  if (!show) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeleteSessionButton, { sessionId, useSessions, t });
}
...
function QueryJumpSettingsTab({
  ...
  const [enable, setEnable] = (0, import_react2.useState)(true);
  const [syncHistoricalQueries, setSyncHistoricalQueries] = (0, import_react2.useState)(true);
  const [showDeleteSession, setShowDeleteSession] = (0, import_react2.useState)(true);
  const [markerStyle, setMarkerStyle] = (0, import_react2.useState)("emoji");
  const [markerSymbol, setMarkerSymbol] = (0, import_react2.useState)(DEFAULT_SYMBOL);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { padding: "8px 4px 24px", maxWidth: 420 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: row, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: hintStyle, children: t("showDeleteSessionHint") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: row, children: [
...
function apply(ctx) {
  ...
  ctx.slots.inject(
    ...
    () => ctx.slots.register(
      ...
      (props) => import_react2.default.createElement(DeleteSessionButtonGate, {
