...
function QueryJumpPanel({
  ...
  const [symbolDraft, setSymbolDraft] = (0, import_react.useState)(DEFAULT_SYMBOL);
  ...
  const patchConfig = (0, import_react.useCallback)(
    async (patch) => {
      if (!isLoopback) return;
      try {
        ...
        open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: cfgBarStyle, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: cfgLabelStyle, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "input",
                    {
                      type: "checkbox",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "input",
                    {
                      ...
                      style: {
                        ...symInputStyle,
                        outline: markerStyle === "emoji" ? "1px solid var(--dsw-alias-label-primary, rgba(0,0,0,.25))" : "none"
                      }
                    }
                  ),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "button",
                    {
                      ...
                      style: {
                        ...segBtnStyle,
                        background: markerStyle === "number" ? "var(--dsw-alias-bg-layer-2, rgba(0,0,0,.06))" : "transparent",
